namespace QuanlyDL.Forms
{
    partial class FormTraCuu
    {
        ...
        private Label lblThongKeToanBo = null!;
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // lblThongKeToanBo (gộp 1 dòng, màu xám dịu, đỡ chói mắt)
            // 
            lblThongKeToanBo.AutoSize = true;
            lblThongKeToanBo.Font = new Font("Segoe UI", 10F);
            lblThongKeToanBo.ForeColor = Color.DimGray;
            lblThongKeToanBo.Location = new Point(23, 22);
            lblThongKeToanBo.Name = "lblThongKeToanBo";
            lblThongKeToanBo.Text = "  🔒 Đang khóa: 0   |   📄 Thường: 0   |  📄 Mật: 0   |  📄 Tối Mật: 0   |  📄 Tuyệt Mật: 0  ";
            // 
            // lblSoCongVanTim
            // 
